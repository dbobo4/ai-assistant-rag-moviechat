...
const envSchema = z.object({
  ...
  PY_BACKEND_URL: z.string().url("PY_BACKEND_URL must be a valid URL").optional(),
  RERANKER_URL: z.string().url("RERANKER_URL must be a valid URL").optional(),
});
...
const rawEnv = {
  ...
  PY_BACKEND_URL: process.env.PY_BACKEND_URL,
  RERANKER_URL: process.env.RERANKER_URL,
};
